function [train_data,train_label,test_data,test_label]=read_data(trainnum1,canshu_num,cnum)

file_read = dir('E:\算法和代码\徐勇主页\人脸识别字典学习算法综述\A Survey of Dictionary\字典综述相关程序\DFEDL\data\orl_40\*');%列出当前目录下的所有子文件夹和文件C:\Users\Administrator\Desktop\office31
file_length = length(file_read);%文件长度
tempdata=load('E:\算法和代码\徐勇主页\人脸识别字典学习算法综述\A Survey of Dictionary\字典综述相关程序\DFEDL\data\orl_40\lfw_1.mat');%导入具体的子文件
dim=size(tempdata.fts(1,:),2);%结果为一个矩阵，加一个2表示返回列数4096
folder='E:\算法和代码\徐勇主页\人脸识别字典学习算法综述\A Survey of Dictionary\字典综述相关程序\DFEDL\data\orl_40\';%文件夹
...
train_data=zeros(dim,Class*trainnum1);%每类取多少个作为训练，
